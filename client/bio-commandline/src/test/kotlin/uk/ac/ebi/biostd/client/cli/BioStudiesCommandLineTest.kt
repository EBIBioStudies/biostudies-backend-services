...
//        every { getClient("http://localhost:8080", "user", "123456", null) } returns mockWebClient
//        every { getClient("http://localhost:8080", "user", "123456", "other") } returns mockWebClient
//    }
//
//    @AfterEach
...
//        verify(exactly = 1) { getClient("http://localhost:8080", "user", "123456", null) }
//    }
//
//    @Test
...
//
//        testInstance.main(args)
//        verify(exactly = 1) { getClient("http://localhost:8080", "user", "123456", "other") }
//    }
//
//    @Test
