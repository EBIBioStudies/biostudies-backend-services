...
internal class SubmissionService {
    ...
    fun submitAsync(request: SubmissionRequest): AcceptedSubmission = performRequest {
    ...
    fun migrate(request: MigrationRequest): Unit = performRequest {
    ...
    fun validateFileList(request: ValidateFileListRequest) = performRequest {
