...
internal class GrantSubmissionPermissionCommand(
    private val securityService: SecurityService,
) : CliktCommand(name = "grantSubmissionPermission") {
    ...
    override fun run() {
        ...
        securityService.grantSubmissionPermission(request)
        echo("The user $targetUser has been granted the $accessType permission in the submission $accNo")
    }
}
