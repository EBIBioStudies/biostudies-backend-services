...
internal class GrantCollectionPermissionCommand(
    private val securityService: SecurityService,
) : CliktCommand(name = "grantCollectionPermission") {
    ...
    override fun run() {
        ...
        securityService.grantCollectionPermission(request)
        echo("The user $targetUser has been granted the $accessType permission in the collection $accNo")
    }
}
