...
internal class MultiPartSubmissionClient(
    ...
    override fun submitSingle(
        ...
        val body = getMultipartBody(files, fileMode, USER_SPACE, submission)
    ...
    override fun submitSingle(
        ...
        val body = getMultipartBody(files, fileMode, USER_SPACE, serializedSubmission)
    ...
    private fun getMultipartBody(files: List<File>, fileMode: FileMode, preferredSource: FileOrigin, submission: Any) =
        LinkedMultiValueMap(
