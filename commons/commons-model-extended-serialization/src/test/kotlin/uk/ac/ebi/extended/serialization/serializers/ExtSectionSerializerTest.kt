            ...
            ExtSection(
                ...
                fileList =
                    ExtFileList(
                        ...
                        createExtFileList(
                            NfsFile(
                                filePath = "folder/ref-file.txt",
                                relPath = "Files/folder/ref-file.txt",
                                file = referencedFile,
                                fullPath = referencedFile.absolutePath,
                                md5Calculated = true,
                                md5 = referencedFile.md5(),
                    ...
                    ExtLinkList(
                        ...
                        pageTabFiles =
                            listOf(
                                ...
                                NfsFile(
                                    filePath = "folder/${fileNfs.name}",
                                    relPath = "Files/folder/${fileNfs.name}",
                                    file = fileNfs,
                                    fullPath = fileNfs.absolutePath,
                                    md5Calculated = true,
                                    md5 = fileNfs.md5(),
                ...
                files =
                    listOf(
                        Either.left(
                            NfsFile(
                                filePath = "folder/section-file.txt",
                                relPath = "Files/folder/section-file.txt",
                                file = sectionFile,
                        ...
                        Either.right(
                            ExtFileTable(
                                listOf(
                                    NfsFile(
                                        filePath = "folder/section-file-table.txt",
                                        relPath = "Files/folder/section-file-table.txt",
                                        file = sectionFilesTable,
                                        fullPath = sectionFilesTable.absolutePath,
                                        md5Calculated = true,
                                        md5 = sectionFilesTable.md5(),
                                        size = sectionFilesTable.size(),
                                    ),
                                ),
                            ),
                        ),
