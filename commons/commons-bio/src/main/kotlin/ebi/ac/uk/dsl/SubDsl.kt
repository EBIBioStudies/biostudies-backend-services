...
fun FilesTable.file(name: String, block: BioFile.() -> Unit = {}) = addRow(BioFile(name).apply(block))
...
fun Section.file(name: String, block: BioFile.() -> Unit = {}) = addFile((BioFile(name).apply(block)))
...
fun file(path: String, block: BioFile.() -> Unit = {}) = BioFile(path).apply(block)
