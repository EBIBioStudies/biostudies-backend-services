...
fun basicSubmissionWithComments() =
    tsv {
...
fun submissionWithInnerSubsections() =
    submissionWithSubsection().apply {
        line("Funding", "F-002")
...
fun submissionWithInvalidInnerSubsection() =
    submissionWithSubsection().apply {
...
fun submissionWithInnerSubsectionsTable() =
    submissionWithSubsection().apply {
        line("Study", "S-001")
        line("Type", "Imaging")
        line()
...
fun submissionWithTableWithNoRows() =
    submissionWithRootSection().apply {
        line("Links", "Type")
        line()
    }

fun submissionWithTableWithMoreAttributes() =
    submissionWithRootSection().apply {
        line("Links", "Type")
