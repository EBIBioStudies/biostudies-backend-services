...
class TsvSerializerTest {
    private val testInstance = TsvSerializer()

    @Nested
    inner class SerializeSubmission {
        @Test
        fun `simple submission`() {
    ...
    inner class Section {
        ...
        @Test
        fun `serialize section null attributes`() {
            val section = section("Study") {
                fileList = FileList("file-list")
                attribute("Project", null)
            }
