...
internal open class SqlPersistenceService(
    ...
    override fun getSequenceNextValue(pattern: String): Long {
        suspend fun getNextSequence(pattern: String): Long {
            ...
            return saved.counter.count
        }
        return lockExecutor.executeLocking(pattern) { runBlocking { return@runBlocking getNextSequence(pattern) } }
    }
