...
internal fun ExtSection.toDbSection(submission: DbSubmission, index: Int): DbSection {
...
private fun ExtSection.toDbTableSection(submission: DbSubmission, index: Int, tableIndex: Int): DbSection {
    val section = asSection(submission, index)
    section.tableIndex = tableIndex
    return section
}

private fun List<Either<ExtSection, ExtSectionTable>>.toDbSections(submission: DbSubmission): SortedSet<DbSection> {
    var idx = 0
...
private fun ExtSection.asSection(submission: DbSubmission, sectionIndex: Int): DbSection {
