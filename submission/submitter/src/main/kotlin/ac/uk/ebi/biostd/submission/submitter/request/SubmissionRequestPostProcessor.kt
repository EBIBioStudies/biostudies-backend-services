...
class SubmissionRequestPostProcessor(
    ...
    private fun deleteRemainingFiles(sub: ExtSubmission, previous: ExtSubmission) {
        ...
        logger.info { "${sub.accNo} ${sub.owner} Started cleaning remaining submission files" }
        ...
        logger.info { "${sub.accNo} ${sub.owner} Finished cleaning remaining submission files" }
    }
