...
class SubmissionRequestCleaner(
     ...
     * longer used) are deleted. Note that the submission is queried with the previous version (in negative) as the new
     * version has been already persisted at this point.
     */
