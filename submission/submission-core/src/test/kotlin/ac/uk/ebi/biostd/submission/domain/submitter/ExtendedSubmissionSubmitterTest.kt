...
class ExtendedSubmissionSubmitterTest(
    ...
    inner class LocalExecution {
        ...
        fun `load request`() = runTest {
            ...
            coVerify(exactly = 1) { localExtSubmissionSubmitter.loadRequest(ACC_NO, VERSION) }
            coVerify(exactly = 0) { remoteExtSubmissionSubmitter.loadRequest(any(), any()) }
        }
        ...
        fun `clean request`() = runTest {
            ...
            coVerify(exactly = 1) { localExtSubmissionSubmitter.cleanRequest(ACC_NO, VERSION) }
            coVerify(exactly = 0) { remoteExtSubmissionSubmitter.cleanRequest(any(), any()) }
        }
        ...
        fun `process request`() = runTest {
            ...
            coVerify(exactly = 1) { localExtSubmissionSubmitter.processRequest(ACC_NO, VERSION) }
            coVerify(exactly = 0) { remoteExtSubmissionSubmitter.processRequest(any(), any()) }
        }
        ...
        fun `check released request`() = runTest {
            ...
            coVerify(exactly = 1) { localExtSubmissionSubmitter.checkReleased(ACC_NO, VERSION) }
            coVerify(exactly = 0) { remoteExtSubmissionSubmitter.checkReleased(any(), any()) }
        }
        ...
        fun `handle persisted request`() = runTest {
            ...
            coVerify(exactly = 0) {
                ...
                localExtSubmissionSubmitter.processRequest(any(), any())
                localExtSubmissionSubmitter.checkReleased(any(), any())
                localExtSubmissionSubmitter.saveRequest(any(), any())
