...
class DistributedLockExecutorTest(@Autowired private val mongoTemplate: ReactiveMongoTemplate) {

    private val testInstance = DistributedLockExecutor(mongoTemplate)

    @Test
    fun adquireLockWhenAvailable() = runTest {
    ...
    @Test
    fun adquireLockWhenLock() = runTest {
    ...
    @Test
    fun adquireLockWhenExpired() = runTest {
