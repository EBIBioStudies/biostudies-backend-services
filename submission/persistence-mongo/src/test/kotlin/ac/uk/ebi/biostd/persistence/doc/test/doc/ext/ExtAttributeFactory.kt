...
val rootSectionAttribute = ExtAttribute(
    ...
    reference = ATTRIBUTE_REFERENCE1,
...
val subSectionTableAttribute = ExtAttribute(
    ...
    reference = ATTRIBUTE_REFERENCE2,
...
val rootSectionLinkAttribute = ExtAttribute(
    ...
    reference = ATTRIBUTE_REFERENCE3,
...
val rootSectionTableLinkAttribute = ExtAttribute(
    ...
    reference = ATTRIBUTE_REFERENCE4,
    nameAttrs = ATTRIBUTE_NAME_ATTRS4,
    valueAttrs = ATTRIBUTE_VALUE_ATTRS4
)
