...
class MongoDbReposConfig {
    ...
    @Bean
    internal fun submissionFilesDocDataRepository(
        submissionDocFileRepository: SubmissionDocFileRepository,
    ): SubmissionFilesDocDataRepository = SubmissionFilesDocDataRepository(submissionDocFileRepository)
    ...
    @Bean
    internal fun linkListDocLinkDocDataRepository(linkListDocLinkRepository: LinkListDocLinkRepository): LinkListDocLinkDocDataRepository =
        LinkListDocLinkDocDataRepository(linkListDocLinkRepository)
}
