...
| ExtCollectionSubmitTest         | 7-1     | submit private collection                                                        | Creates public and private collection                                                         |
| ExtCollectionSubmitTest         | 7-2     | submit public collection                                                         |                                                                                               |
| ExtCollectionSubmitTest         | 7-3     | submit duplicated accNo template                                                 |                                                                                               |
| SubmissionToCollectionsTest     | 8-1     | accNo generation from collection template                                        | Considers different test cases on submission attached to a collection                         |
...
| SubmissionReleaseSecretKeyTest  | 27-4    | private submission with secret key and MOVE release mode                         |                                                                                               |
| SubmissionReleaseSecretKeyTest  | 27-5    | release already submitted submission using release operation                     |                                                                                               |
...
| SubmissionDatesTest             | 28-6    | superuser submit and re Submit in the past                                       |                                                                                               |
| SubmissionDatesTest             | 28-7    | superuser make a public submission private                                       |                                                                                               |
| SubmissionDatesTest             | 28-8    | superuser make a Regular user public submission private                          |                                                                                               |
