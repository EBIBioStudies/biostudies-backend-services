...
class SubmissionFileSourceTest(
    ...
    inner class SubmissionsWithFolders {
        ...
        @Test
        @EnabledIfSystemProperty(named = "enableFire", matches = "true")
        fun `6-3-2-1 re submission with directory with files on FIRE`() =
            runTest {
                val submission =
                    tsv {
        ...
        @Test
        @EnabledIfSystemProperty(named = "enableFire", matches = "true")
        fun `6-3-2-2 re-submission with directory with files on FIRE using submission source only`() =
            runTest {
                val fileList =
                    tsv {
                        line("Files", "Type")
        ...
        @Test
        @EnabledIfSystemProperty(named = "enableFire", matches = "true")
        fun `6-3-4 submission with directories with the same name on FIRE`() =
            runTest {
                val submission =
                    tsv {
        ...
        fun `6-3-5 submission with directory with files on NFS`() =
            runTest {
                val submission =
                    tsv {
        ...
        @Test
        @EnabledIfSystemProperty(named = "enableFire", matches = "false")
        fun `6-3-6 submission with directories with the same name on NFS`() =
            runTest {
                val submission =
                    tsv {
                        line("Submission", "S-FSTST34")
    ...
    fun `6-4 multiple file references`() =
        runTest {
            ...
            val secondVersionFileList =
                tsv {
                    line("Files", "Type")
                    line("MultipleReferences.txt", "A reference")
                    line()
                }.toString()
            val secondVersionPagetab =
                tsv {
                    line("Submission", "S-FSTST4")
    ...
    @Test
    @EnabledIfSystemProperty(named = "enableFire", matches = "true")
    fun `6-8 submission with files with the same md5 and different path`() =
        runTest {
