...
fun assertAllInOneSubmissionTsv(
    tsv: String,
    accNo: String,
) {
    val lines = tsv.split("\n")
    ...
    val expectedRootSectionFilesTable =
        tsv {
    ...
    val expectedSubsectionLinksTable =
        tsv {
...
internal val expectedAllInOneTsvFileList =
    tsv {
        line("Files", "Type")
...
internal val expectedAllInOneTsvInnerFileList =
    tsv {
        line("Files", "Type")
