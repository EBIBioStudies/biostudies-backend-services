...
class DeletePermissionTest(
    ...
    @Test
    fun `1-5 regular user with access tag permission deletes private submission`() =
        runTest {
            val submission =
                tsv {
    ...
    @Test
    fun `1-6 regular user with access tag permission deletes public submission`() =
        runTest {
            val submission =
                tsv {
    ...
    @Test
    fun `1-7 regular user with admin persmission deletes private submission`() =
        runTest {
            val submission =
                tsv {
    ...
    @Test
    fun `1-8 regular user with admin persmission deletes public submission`() =
        runTest {
            val submission =
                tsv {
    ...
    @Test
    fun `1-10 delete own private submission`() =
        runTest {
            val submission =
                tsv {
    ...
    @Test
    fun `1-11 delete own public subsmissions`() =
        runTest {
            val submission1 =
                tsv {
    ...
    @Test
    fun `1-12 delete own private subsmissions`() =
        runTest {
            val submission1 =
                tsv {
    ...
    @Test
    fun `1-13 resubmit deleted submission`() =
        runTest {
            val submission =
                tsv {
    ...
    private suspend fun assertDeletedSubmission(
        accNo: String,
        version: Int = -1,
    ) {
